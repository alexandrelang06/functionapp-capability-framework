/*
  ...
  2. Constraints & Validation
    ...
    - Validate maturity levels JSON structure and content
*/

-- Add new columns to processes table (excluding description which already exists)
...
-- Create function to validate maturity levels JSON structure
